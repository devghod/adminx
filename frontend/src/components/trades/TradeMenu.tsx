...
const MenuItem = ({ 
  ...
  return (
    <div
      className={
        `w-full bg-white dark:bg-black border hover:border-gray-500/10 hover:shadow-2xl hover:dark:ring-2 hover:dark:ring-violet-900 font-semibold text-gray-500 dark:text-slate-400 cursor-pointer transition-all duration-500 rounded-lg p-4
