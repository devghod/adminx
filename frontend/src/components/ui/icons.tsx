...
function SortIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill='currentColor'
        d='M130.4 268.2c5 12 16.6 19.8 29.6 19.8h320c12.9 0 24.6-7.8 29.6-19.8s2.2-25.7-6.9-34.9l-160-160c-12.5-12.5-32.8-12.5-45.3 0l-160 160c-9.2 9.2-11.9 22.9-6.9 34.9zm0 103.5c-5 12-2.2 25.7 6.9 34.9l160 160c12.5 12.5 32.8 12.5 45.3 0l160-160c9.2-9.2 11.9-22.9 6.9-34.9S492.9 352 480 352H160c-12.9 0-24.6 7.8-29.6 19.8z'
      />
    </svg>
  );
}

function SortAscIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
    ...
    >
      <path
        fill='currentColor'
        d='M160 288c-12.9 0-24.6-7.8-29.6-19.8s-2.2-25.7 7-34.8l160-160c12.5-12.5 32.8-12.5 45.3 0l160 160c9.2 9.2 11.9 22.9 6.9 34.9S492.9 288 480 288z'
      />
    </svg>
  );
}
...
function SortDescIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill='currentColor'
        d='M160 352c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 7 34.8l160 160c12.5 12.5 32.8 12.5 45.3 0l160-160c9.2-9.2 11.9-22.9 6.9-34.9S492.9 352 480 352z'
      />
    </svg>
  );
}

function UserRolesIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
