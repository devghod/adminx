...
const dropdownMenuItemVariants = cva(
  'group relative font-medium flex h-[25px] select-none items-center justify-between rounded hover:bg-gray-200 dark:hover:bg-gray-500 p-4 text-[13px] leading-none outline-none',
);
